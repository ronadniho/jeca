    ...
    children: [{
    ...
    },
      {
        ...
        children: [{
          ...
          name: '部门模板', //部门管理
          component: resolve => {
            require(['@/views/user/department/departmentTmp.vue'], resolve)
          },
          children: [
            {
              ...
              name: '部门列表',
              component: resolve => {
                require(['@/views/user/department/list.vue'], resolve)
              },
            }, {
              path: '/department/add', //部门添加
              name: '部门添加',
              component: resolve => {
                require(['@/views/user/department/add.vue'], resolve)
              },
            }, {
              path: '/department/edit', //部门添加
              name: '部门修改',
              component: resolve => {
                require(['@/views/user/department/edit.vue'], resolve)
              },
            }, {
              path: '/departmentMember/list', //部门添加
              name: '部门成员列表',
              component: resolve => {
                require(['@/views/user/department/memberList.vue'], resolve)
              },
            }
          ]
        },
    ...
    children: [
      {
        ...
        name: '内容复用', //内容复用
        component: resolve => {
          require(['@/views/operate/contentReuse/list.vue'], resolve)
        },
      },
      {
        path: '/workflow',
        ...
        children: [{
          ...
          name: '工作流列表',
          component: resolve => {
            require(['@/views/operate/workflow/list.vue'], resolve)
          },
        }, {
          path: '/workflow/save',//工作流添加
          name: '工作流添加',
          component: resolve => {
            require(['@/views/operate/workflow/edit.vue'], resolve)
          },
        }, {
        ...
        children: [
          {
            ...
            name: '共享列表',
            component: resolve => {
              require(['@/views/operate/contentShare/list.vue'], resolve)
            },
          },
          {
            ...
            name: '内容查看',
            component: resolve => {
              require(['@/views/operate/contentShare/edit.vue'], resolve)
            },
          },
        ]
      },
      ...
      },
      {
        ...
        children: [{
          ...
          name: '问卷列表',
          component: resolve => {
            require(['@/views/operate/vote/list.vue'], resolve)
          },
        }, {
          path: '/vote/save',//问卷新增
          name: '问卷新增',
          component: resolve => {
            require(['@/views/operate/vote/edit.vue'], resolve)
          },
        }, {
            ...
            children: [
              {
                ...
                name: '采集列表',
                component: resolve => {
                  require(['@/views/operate/collection/manage/list.vue'], resolve)
                },
              },
              {
                ...
                name: '采集添加',
                component: resolve => {
                  require(['@/views/operate/collection/manage/edit.vue'], resolve)
                },
              },
              {
            ...
            children: [
              {
                ...
                name: '采集列表',
                component: resolve => {
                  require(['@/views/operate/collection/history/list.vue'], resolve)
                },
              },
            ]
          },
            ...
            children: [
              {
                ...
                name: '采集查看',
                component: resolve => {
                  require(['@/views/operate/collection/speed/view.vue'], resolve)
                },
              },
            ]
          },
    ...
    children: [
      {
        ...
        name: '全文检索', //全文检索
        component: resolve => {
          require(['@/views/operate/fullTextSearch/input.vue'], resolve)
        },
      },
      {
        path: '/dictionary',
        ...
        children: [
          {
            ...
            name: '字典列表',
            component: resolve => {
              require(['@/views/operate/dictionary/list.vue'], resolve)
            },
          },
        ]
      },
        ...
        children: [
          {
            ...
            name: '内容回收站列表',
            component: resolve => {
              require(['@/views/operate/contentCycle/list.vue'], resolve)
            },
          },
        ]
      },
        ...
        children: [
          {
            ...
            name: '附件管理',
            component: resolve => {
              require(['@/views/operate/file/list.vue'], resolve)
            },
          },
        ]
      },
        ...
        children: [
          {
            ...
            name: '二维码管理创建',
            component: resolve => {
              require(['@/views/operate/dimensioncode/create.vue'], resolve)
            },
          },
        ]
      },
        ...
        children: [
          {
            ...
            name: '智能表单列表',
            component: resolve => {
              require(['@/views/operate/customForm/list.vue'], resolve)
            },
          },
          {
            ...
            name: '智能表单添加',
            component: resolve => {
              require(['@/views/operate/customForm/add.vue'], resolve)
            },
          },
          {
            ...
            name: '智能表单修改',
            component: resolve => {
              require(['@/views/operate/customForm/edit.vue'], resolve)
            },
          },
          {
              ...
              [
                {
                  ...
                  name: '智能表单记录列表',
                  component: resolve => {
                    require(['@/views/operate/customForm/record/list.vue'], resolve)
                  },
                },
                {
                  ...
                  name: '智能表单记录详情',
                  component: resolve => {
                    require(['@/views/operate/customForm/record/view.vue'], resolve)
                  },
                }
              ]
          },
        ...
        children: [
          {
            ...
            name: '评分组列表',
            component: resolve => {
              require(['@/views/operate/scoregroup/list.vue'], resolve)
            },
          },
          {
            ...
            name: '评分组添加',
            component: resolve => {
              require(['@/views/operate/scoregroup/edit.vue'], resolve)
            },
          },
          {
            ...
            children: [
              {
                ...
                name: '评分项列表',
                component: resolve => {
                  require(['@/views/operate/scoregroup/scoreitem/list.vue'], resolve)
                },
              },
              {
                ...
                name: '评分项添加',
                component: resolve => {
                  require(['@/views/operate/scoregroup/scoreitem/edit.vue'], resolve)
                },
              },
              {
            ...
            children: [
              {
                ...
                name: 'tag列表',
                component: resolve => {
                  require(['@/views/operate/word/tag/list.vue'], resolve)
                },
              },
            ]
          },
            ...
            children: [
              {
                ...
                name: '关键词列表',
                component: resolve => {
                  require(['@/views/operate/word/keyword/list.vue'], resolve)
                },
              },
            ]
          },
            ...
            children: [
              {
                ...
                name: '来源列表',
                component: resolve => {
                  require(['@/views/operate/word/origin/list.vue'], resolve)
                },
              },
            ]
          },
            ...
            children: [
              {
                ...
                name: '热词列表',
                component: resolve => {
                  require(['@/views/operate/word/searchwords/list.vue'], resolve)
                },
              },
            ]
          }
