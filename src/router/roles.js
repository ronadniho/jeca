 ...
 },
{
    name: '栏目',
    role: '/channel', 
    api: [api.channelList,api.channelTree,api.channelCopy] ,
    children:[
        {
            name:'列表',
            role:'/channel/list',
        ...
        },
        {
            ...
            children:[
                ...
                },
                {
                    ...
                    api: [api.statisticWorkloadList,api.statisticContentList,api.fullTextSearchChannelList]    
                },
                {
                    name: '评论量',
...
},
{
    ...
    children:[{
        ...
        children:[{
            ...
            api: [api.adminGlobleUpdate]
         },{
            name: '添加',
            role: '/adminGlobal/add',
            api: [api.adminGlobleAdd]
         }]
    },{
        name:'管理员（本站）',
        role:'/adminGloCal',
        ...
        children:[{
            ...
            api: [api.departmentGet,api.guestbookTypeList,api.siteTree,api.departmentTree,api.getAllChannel,api.groupSave]
        },{
            name:'修改',
            role:'/department/update',
            api: [api.departmentGet,api.guestbookTypeList,api.siteTree,api.departmentTree,api.getAllChannel,api.departmentUpdate]
        },{
            name:'删除',
...
},
{
    ...
    children:[
    {
        name:'内容复用',
        role:'/contentReuse',
        api: [api.siteTree,api.contentList],
        children:[
            {
                name: '内容列表',
                role: '/contentReuse/list',
                api: [api.contentList,api.siteTree]    
            },
            {
                name: '复制',
                role: '/contentReuse/copy',
                api: [api.contentCopy]    
            },
            {
                name: '引用',
                role: '/contentReuse/refer',
                api: [api.contentRefer]    
            },
        ]
    },
    {
        ...
        children:[
            ...
            },
            {
                name: '详情',
                role: '/workflow/get',
                api: [api.workflowGet,api.roleList]    
            },
            {
                name: '添加',
                role: '/workflow/save',
                api: [api.workflowSave,]    
            },
            {
                name: '修改',
                role: '/workflow/update',
                api: [api.workflowUpdate]    
            },
            {
                name: '删除',
                role: '/workflow/delete',
                api: [api.workflowDelete]    
            },
            {
                name: '保存排序',
                role: '/workflow/priority',
                api: [api.workflowPriority]    
            },
        ]
    },
    {
    ...
    },
    {
        name:'共享管理',
        role:'/contentShare',
        api: [api.contentShareList],
        children:[
            {
                name: '列表',
                role: '/contentShare/list',
                api: [api.contentShareList]    
            },
            {
                name: '删除',
                role: '/contentShare/delete',
                api: [api.contentShareDelete]    
            },
            {
                name: '查看',
                role: '/contentShare/view',
                api: [api.contentView,]    
            },
            {
                name: '审核',
                role: '/contentShare/aduit',
                api: [api.contentShareAduit]    
            }
        ]
    },
    {
        ...
        children:[
            ...
            },
            {
                ...
                api: [api.frameGetDB,api.mysqlDataList,api.oracleDataList,api.sqlserverDataList,api.db2DataList,
                    ...
                    api.mysqDataListDataBases,api.sqlserverDataListDataBases,
         ...
         },
          {
            ...
            },
             {
                ...
                },
                {
                    name:'自定义表单',
                    role:'/customForm',
                    api: [api.customFormList,api.customFormGet,api.customFormPriority,api.templateList],
                    children:[
                        {
                            name: '列表',
                            role: '/customForm/list',
                            api: [api.customFormList]    
                        },
                        {
                            name: '删除',
                            role: '/customForm/delete',
                            api: [api.customFormDelete]    
                        },
                        {
                            name: '表单记录',
                            role: '/customForm/record',
                            api: [api.customRecordPage],
                            children:[
                                {
                                    name: '列表',
                                    role: '/customForm/record/list',
                                    api: [api.customRecordPage]    
                                },
                                {
                                    name: '详情',
                                    role: '/customForm/record/view',
                                    api: [api.customRecordGet]    
                                },
                                {
                                    name: '删除',
                                    role: '/customForm/record/delete',
                                    api: [api.customRecordDelete]    
                                },
                                {
                                    name: '审核',
                                    role: '/customForm/record/check',
                                    api: [api.customRecordCheck]    
                                },
                            ]   
                        },
                        {
                            name: '修改',
                            role: '/customForm/edit',
                            api: [
                                api.customFormUpdate,
                                api.customFiledList,
                                api.customFiledGet,
                                api.customFiledSave,
                                api.customFiledUpdate,
                                api.customFiledDelete,
                                api.customFiledCheck,
                                api.customFiledPriority,
                            ]    
                        },
                        {
                            name: '添加',
    ...
    children:[
        {
            name:'模板',
            role:'/template',
            api: ['/api/admin/template/tree','/api/admin/template/getSolutions','/api/admin/template/solutionupdate','/api/admin/template/get'],
            children:[
                {
                    name:'列表',
                    role:'/templatelist',
...
},
{
    ...
    children:[{
        ...
        children:[
            ...
            {
                name: '详情',
                role: '/globel/site/get',
                api: [api.siteGet]                           
            },
            {
                name: '添加',
                role: '/globel/site/add',
                api: [api.siteSave,api.siteGet]                           
            },
            {
                name: '修改',
                role: '/globel/site/edit',
                api: [api.siteUpdate]                           
            },
            {
                name: '删除',
                role: '/globel/site/delete',
                api: [api.siteDelete]                           
            }
        ]  
    },{
