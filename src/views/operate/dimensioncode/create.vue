         ...
         <el-form  ref="form" :model="dataInfo" :rules="rules" class="cms-form" label-width="162px">
            ...
            <el-form-item label="二维码内容" class="flex-100 "  prop="content">
             ...
             <el-form-item label="logo文字大小" class="flex-100 "  prop="fontSize">
              ...
              <el-input  class="cms-width" v-model="dataInfo.size"> </el-input>
              <span class="gray">规定生成之后图片的宽和高</span>
            </el-form-item>  
              <div class="form-footer">
                    <el-button type="primary"  @click="grenQR()"
                        v-perms="'/drawApply/create'"
                    >生成二维码</el-button>
        ...
        grenQR() {     
            ...
            axios.post(this.$api.dimensioncodeCreate,this.dataInfo).then(res=>{
                if(res.code == '200'){
                    ...
                    // setBaseUrl()+
                    this.qrcodeUrl =  setBaseUrl()+res.body.url+'?str='+getRand();
                } 
                this.loading = false;
            }).catch(error=>{
                this.loading = false;
