  ...
  <section class="cms-body" v-loading="loading">
    ...
    <el-form  ref="form" :model="dataInfo" :rules="rules" class="cms-form" label-width="162px">
        ...
        <el-form-item label="内容地址集" class="flex-100 "  >
          ...
          <el-row>
              <el-col :span="12">
                <el-input v-model="dataInfo.linksetStart" class="cms-width" type="textarea" ></el-input>
              </el-col>
              <el-col :span="12">
                <el-input v-model="dataInfo.linksetEnd" class="cms-width" type="textarea" ></el-input>
              </el-col>
          </el-row>
        </el-form-item>
        <!-- 内容地址-->
        <el-form-item label="内容地址" class="flex-100 "  >
          <el-row>
              <el-col :span="12">
                <el-input v-model="dataInfo.linkStart" class="cms-width" type="textarea" ></el-input>
              </el-col>
              <el-col :span="12">
                <el-input v-model="dataInfo.linkEnd" class="cms-width" type="textarea" ></el-input>
              </el-col>
          </el-row>
        </el-form-item>
         <!-- 内容分页地址-->
        <el-form-item label="内容分页地址" class="flex-100 "  >
          <el-row>
              <el-col :span="12">
                <el-input v-model="dataInfo.contentPageStart" class="cms-width" type="textarea" ></el-input>
              </el-col>
              <el-col :span="12">
                <el-input v-model="dataInfo.contentPageEnd" class="cms-width" type="textarea" ></el-input>
              </el-col>
          </el-row>
        </el-form-item>
         <!-- 内容分页链接地址-->
        <el-form-item label="内容分页链接地址" class="flex-100 "  >
          <el-row>
              <el-col :span="12">
                <el-input v-model="dataInfo.pageLinkStart" class="cms-width" type="textarea" ></el-input>
              </el-col>
              <el-col :span="12">
                <el-input v-model="dataInfo.pageLinkEnd" class="cms-width" type="textarea" ></el-input>
              </el-col>
          </el-row>
        </el-form-item>
         <!-- 类型图-->
        <el-form-item label="类型图" class="flex-100 "  v-if="!dataInfo.defTypeImg">
          <el-row>
              <el-col :span="12">
                <el-input v-model="dataInfo.typeImgStart" class="cms-width" type="textarea" ></el-input>
              </el-col>
              <el-col :span="12">
                <el-input v-model="dataInfo.typeImgEnd" class="cms-width" type="textarea" ></el-input>
              </el-col>
          </el-row>
        </el-form-item>
        <!-- 标题-->
        <el-form-item label="标题" class="flex-100 "  >
          <el-row>
              <el-col :span="12">
                <el-input v-model="dataInfo.titleStart" class="cms-width" type="textarea" ></el-input>
              </el-col>
              <el-col :span="12">
                <el-input v-model="dataInfo.titleEnd" class="cms-width" type="textarea" ></el-input>
              </el-col>
          </el-row>
        </el-form-item>
        <!-- 描述-->
        <el-form-item label="描述" class="flex-100 "  >
          <el-row>
              <el-col :span="12">
                <el-input v-model="dataInfo.descriptionStart" class="cms-width" type="textarea" ></el-input>
              </el-col>
              <el-col :span="12">
                <el-input v-model="dataInfo.descriptionEnd" class="cms-width" type="textarea" ></el-input>
              </el-col>
          </el-row>
        </el-form-item>
        <!-- 内容-->
        <el-form-item label="内容" class="flex-100 "  >
          <el-row>
              <el-col :span="12">
                <el-input v-model="dataInfo.contentStart" class="cms-width" type="textarea" ></el-input>
              </el-col>
              <el-col :span="12">
                <el-input v-model="dataInfo.contentEnd" class="cms-width" type="textarea" ></el-input>
              </el-col>
          </el-row>
        </el-form-item>
        <!-- 浏览量-->
        <el-form-item label="浏览量" class="flex-100 ">
          <el-row>
              <el-col :span="12">
                <el-input v-model="dataInfo.viewStart" class="cms-width" type="textarea" ></el-input>
              </el-col>
              <el-col :span="12">
                <el-input v-model="dataInfo.viewEnd" class="cms-width" type="textarea" ></el-input>
              </el-col>
          </el-row>
        </el-form-item>
        <!-- 浏览量访问地址-->
        <el-form-item label="浏览量访问地址" class="flex-100 "  >
          <el-row>
              <el-col :span="12">
                <el-input v-model="dataInfo.viewLink" class="cms-width" type="textarea" ></el-input>
              </el-col>
              <el-col :span="12">
                <el-input v-model="dataInfo.viewIdEnd" class="cms-width" type="textarea" ></el-input>
              </el-col>
          </el-row>
        </el-form-item>
        <!-- 作者-->
        <el-form-item label="作者" class="flex-100 " >
          <el-row>
              <el-col :span="12">
                <el-input v-model="dataInfo.authorStart" class="cms-width" type="textarea" ></el-input>
              </el-col>
              <el-col :span="12">
                <el-input v-model="dataInfo.authorEnd" class="cms-width" type="textarea" ></el-input>
              </el-col>
          </el-row>
        </el-form-item>
        <!-- 来源-->
        <el-form-item label="来源" class="flex-100 "  >
          <el-row>
              <el-col :span="12">
                <el-input v-model="dataInfo.originStart" class="cms-width" type="textarea" ></el-input>
              </el-col>
              <el-col :span="12">
                <el-input v-model="dataInfo.originEnd" class="cms-width" type="textarea" ></el-input>
              </el-col>
          </el-row>
        </el-form-item>
         <!-- 指定来源-->
        <el-form-item label="指定来源" class="flex-100 "  >
          <el-row>
              <el-col :span="24">
                <el-input v-model="dataInfo.originAppoint" class="cms-width"  ></el-input>
              </el-col>
          </el-row>
        </el-form-item>
        <!-- 发布时间-->
        <el-form-item label="发布时间" class="flex-100 "  >
          <el-row>
              <el-col :span="12">
                <el-input v-model="dataInfo.releaseTimeStart" class="cms-width" type="textarea" ></el-input>
              </el-col>
              <el-col :span="12">
                <el-input v-model="dataInfo.releaseTimeEnd" class="cms-width" type="textarea" ></el-input>
              </el-col>
          </el-row>
        </el-form-item>
         <!-- 屏蔽内容-->
        ...
        <el-form-item v-for="(item,index) in shields" :key="index" label="内容屏蔽" class="flex-100 "  >
            <el-row>
                <el-col :span="12">
                  <el-input v-model="item.shieldStart" class="cms-width" type="textarea" ></el-input>
                </el-col>
                <el-col :span="10">
                  <el-input v-model="item.shieldEnd" class="cms-width" type="textarea" ></el-input>
                </el-col>
                <el-col :span="2">
        ...
        <el-form-item v-for="(item,index) in replaces" :key="index" label="替换" class="flex-100 "  >
            <el-row>
                <el-col :span="12">
                  <el-input v-model="item.keyword" class="cms-width" type="textarea" ></el-input>
                </el-col>
                <el-col :span="10">
                  <el-input v-model="item.replaceWord" class="cms-width" type="textarea" ></el-input>
                </el-col>
                <el-col :span="2">
