    ...
    <section class="cms-body" v-loading="loading">
        ...
        <el-form  ref="form" :model="dataInfo" :rules="rules" class="cms-form" label-width="162px">
            ...
            <el-form-item class="flex-50">              
                <el-button @click.native="clear($api.configAttrClear)"
                       v-perms="'/config/configAttrUpdate'"
                  >清除缓存内容</el-button> 
            </el-form-item> 

            <div class="form-footer">
                <el-button type="primary"  @click="update()"
                    v-perms="'/globel/attrUpdate'"
                >修改</el-button>
  ...
  data() {
    ...
    return {
     ...
     methods:{
        ...
        axios
        .all([
             axios.post(api.configAttrGet), //axios批量发送请求//axios批量发送请求
        ])
        .then(
            axios.spread((attr)=>{
